...
if (seedCount === 0) {
  ...
  const seedSales = db.transaction(() => {
    ...
    insSale.run(uuidv4(), '181A Edgecliff Road, Woollahra NSW', 'Woollahra', 'Eastern Suburbs', 'Apartment Blocks', 'EOI', 5300000, null, null, 158, null, 'B! Neighbourhood Centre', '1:1', null, null, '- 3 x retail shops and 4 x 2-bedroom fully furnished residential flats. Mixed-use redevelopment potential.');
    ...
    insSale.run(uuidv4(), '543 Old South Head Road, Rose Bay NSW', 'Rose Bay', 'Eastern Suburbs', 'Apartment Blocks', 'Auction', 4560000, null, null, 335, null, null, null, null, null, '- 4 x 2-bedroom units aon a coner position');
    ...
    insSale.run(uuidv4(), '56 Campbell Parade, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Apartment Blocks', 'EOI', 20650000, null, null, 368, null, 'B4 - Mixed use Zoning ', '3:1', '2020-12-01', 2020, '4 x 2-bedroom apartments & commercial shop (trading as a cafe).');
    ...
    insSale.run(uuidv4(), '156 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Apartment Blocks', 'Auction', 15000000, null, null, 449, 200, 'R3 Medium Density ', '0.6', '1991-01-08', 1991, '2 x 3 bedroom');
    insSale.run(uuidv4(), '154 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Apartment Blocks', 'Auction', 22000000, null, null, 465, 480, 'R3 Medium Density ', '0.6', '1991-01-08', 1991, '6 x 2 bedroom');
    ...
    insSale.run(uuidv4(), '8 Etham Avenue, Darling Point NSW', 'Darling Point', null, 'Apartment Blocks', 'EOI', 12000000, null, null, 506, 597, 'R3 medium Density ', '0.9:1 ', null, null, '6 x 2 bedrooms, 1.5 bathroom and 4 garages');
    ...
    insSale.run(uuidv4(), '30 Yarranabbe Road, Darling Point NSW', 'Darling Point', null, 'Apartment Blocks', 'Auction', 9000000, null, null, 340, 337, 'R3 medium Density ', '1:1', null, null, '2 x 3 Bedroom + 1 x 2 Bedroom');
    ...
    insSale.run(uuidv4(), '1 Gordon Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Apartment Blocks', 'Auction', 3300000, null, null, 335, null, null, null, null, null, '6 x 1 bedroom');
    ...
    insSale.run(uuidv4(), '286-294a Campbell Parade, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Apartment Blocks', 'Auction', 25400000, null, null, 689, 1004, null, null, '2020-11-06', 2020, '6 Apartments 4 shops');
    ...
    insSale.run(uuidv4(), '22 Greenwich Road', 'Greenwich', null, 'Apartment Blocks', 'Auction', 9560000, 450000, 4.7, null, 483, null, null, '2019-11-12', 2019, null);
