...
try { db.exec('ALTER TABLE tracking ADD COLUMN units INTEGER'); } catch(e) {}
// Agreed sale price captured at exchange, carried into the sale on settlement
try { db.exec('ALTER TABLE tracking ADD COLUMN sale_price REAL'); } catch(e) {}
// Revised/adjusted guide when a campaign is repriced — powers quote-accuracy analysis
try { db.exec('ALTER TABLE tracking ADD COLUMN adjusted_guide REAL'); } catch(e) {}
try { db.exec('ALTER TABLE sales ADD COLUMN adjusted_guide REAL'); } catch(e) {}
