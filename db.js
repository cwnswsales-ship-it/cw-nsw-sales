...
if (seedCount === 0) {
  ...
  const seedSales = db.transaction(() => {
    ...
    insSale.run(uuidv4(), '354 New South Head Road, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Commercial', 'Off-Market', 8630000, null, null, 204, null, 'E1 Local Centre', '2.5:1', '2023-07-01', 2023, null);
    ...
    insSale.run(uuidv4(), '164-166 Edgecliff Road, Woollahra NSW', 'Woollahra', 'Eastern Suburbs', 'Commercial', 'Auction', 5800000, null, null, 506, null, 'B1 Neighbourhood Centre', '1:1', '2022-09-01', 2022, '- Dual frontage mixed use property. 2 Ground floor retail shops with a 2/3bedroom residence on the upper level.');
    insSale.run(uuidv4(), '453-457 New South Head Road, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Commercial', 'Auction', 13000000, null, null, 329, 759, 'B2 local Centre', '2.5:1', '2022-10-01', 2022, '- 2-level commercial freehold with expired lease structures favoruing immediate rennovation.');
    ...
    insSale.run(uuidv4(), '557 Old South Head Road, Rose Bay NSW', 'Rose Bay', 'Eastern Suburbs', 'Residential', 'Auction', 6800000, null, null, 506, null, 'R3 Medium Density', '0.9:1', '2023-01-07', 2023, '- Block of 6 x 2-bedroom units with balconies');
    insSale.run(uuidv4(), '141-155 Curlewis Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Development Site', 'Off-Market', 55250000, null, null, 1557, null, 'B2 Local Centre', '2:1', '2022-05-05', 2022, '- three mixed use one & two storey buildings. Gorund floor retail and upper level residential');
    ...
    insSale.run(uuidv4(), '181A Edgecliff Road, Woollahra NSW', 'Woollahra', 'Eastern Suburbs', 'Residential', 'EOI', 5300000, null, null, 158, null, 'B! Neighbourhood Centre', '1:1', null, null, '- 3 x retail shops and 4 x 2-bedroom fully furnished residential flats. Mixed-use redevelopment potential.');
    insSale.run(uuidv4(), '48 Oxofrd Street, Woollahra NSW', 'Woollahra', 'Eastern Suburbs', 'Commercial', 'EOI', 4500000, null, null, 377, 254.04, 'R2 Low Density Residential ', null, null, null, '- Existing Warehouse with tyre business tenant on 3 year lease with 3 year option from 2024');
    insSale.run(uuidv4(), '46 Hewlett Street, Bronte NSW', 'Bronte', 'Eastern Suburbs', 'Residential', 'Auction', 6000000, null, null, 450, null, 'R2 Low Density ', '0.5:1', null, null, '4 x 2-bedroom units, 1 bath');
    ...
    insSale.run(uuidv4(), '54 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 10500000, null, null, 490, null, 'R2 Low Density', '0.5:1', '2022-09-11', 2022, 'Block of six units: 3 x two-bedroom and 3 x three-bedroom units.');
    insSale.run(uuidv4(), '126 Old South Head Road, Bellevue Hill NSW', 'Bellevue Hill', 'Eastern Suburbs', 'Residential', 'Auction', 5500000, null, null, 368, null, 'R3 Medium Density', '1.3:1', null, null, 'Block of 7 Apartments: 6 x two bedroom & 1 x one-bedroom + Study');
    ...
    insSale.run(uuidv4(), '543 Old South Head Road, Rose Bay NSW', 'Rose Bay', 'Eastern Suburbs', 'Residential', 'Auction', 4560000, null, null, 335, null, null, null, null, null, '- 4 x 2-bedroom units aon a coner position');
    insSale.run(uuidv4(), '182 Clovelly Road, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 5050000, null, null, 543.7, null, 'R3 Medium Density', '0.75:1', null, null, '- 4 x 2 bed strata apartments');
    insSale.run(uuidv4(), '11 Clyde Street, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 7100000, null, null, 757, null, 'R2 Low Density ', '0.5:1', null, null, '6 x 2-bedroom apartments, 1 x 1-bed apartments, 9 garages');
    insSale.run(uuidv4(), '17-19 Baden Street, Coogee NSW', 'Coogee', 'Eastern Suburbs', 'Residential', 'Auction', 10500000, null, null, 594, null, 'R3 Medium Density', '0.9:1', null, null, '19 Baden Street: 6 x 2.5 Bedroom units | 17 Baden Street: 4 Bedroom home positioned at the rear of the property.');
    insSale.run(uuidv4(), '104 Warners Avenue, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 7750000, null, null, 418, null, 'R3 Medium Density', '0.9:1', '2023-03-02', 2023, '4 x 2-beds/1 Bath apartments');
    insSale.run(uuidv4(), '100 Ramsgate Avenue, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 11500000, null, null, 477, null, 'R3 Medium Density ', '0.9:1', null, null, '4 x 2-Bedroom Units (Strata)');
    ...
    insSale.run(uuidv4(), '39 Belgrave Street, Bronte NSW', 'Bronte', 'Eastern Suburbs', 'Residential', 'Auction', 4750000, null, null, null, null, 'R2 Low Density ', '0.5:1', null, null, '4 x 3-bedroom units. 2 x double tandem lock up garages.');
    ...
    insSale.run(uuidv4(), '222 Bronte Road, Waverley NSW', 'Waverley', 'Eastern Suburbs', 'Medical/Healthcare', 'Auction', 1930000, null, null, 221, null, 'R3 Medium Density Residential ', '0.9:1', '2022-05-07', 2022, 'DA approved medical centre for professional consulting rooms');
    ...
    insSale.run(uuidv4(), '307 Clovelly Road', 'Clovelly', 'Eastern Suburbs', 'Retail', null, 2325000, null, null, 158, null, 'B! Neighbourhood Centre', '1:1', null, null, 'Two storey-shop top with 2 residential units and rear lane acces');
    insSale.run(uuidv4(), '3a Bundarra Road, Bellevue Hill NSW', 'Bellevue Hill', 'Eastern Suburbs', 'Residential', 'Auction', 8250000, null, null, 582, null, 'R3 Medium Density ', '0.75:1', '2022-11-07', 2022, '3 x self contained whole floor residences (3 bed units + 3 Baths)');
    insSale.run(uuidv4(), '30 Bray Street, Bronte NSW', 'Bronte', 'Eastern Suburbs', 'Residential', 'Auction', 3855000, null, null, 563, null, 'R3 Medium Density ', '0.6:1', null, null, '2 x 3 bedroom residences + 2 garages');
    ...
    insSale.run(uuidv4(), '49 Wallis Parade, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 3900000, null, null, 227, null, 'R3 Medium Density ', '0.9:1', null, null, '4 x 1-bedroom plus sunroom Strata Apartments');
    insSale.run(uuidv4(), '81 Oakley Road, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 6225000, 155000, 2.49, 481, null, 'R3 Medium Density ', '0.6:1', '2022-05-04', 2022, '4 x 2-bedroom plus sunrooms.');
    insSale.run(uuidv4(), '41 Hall Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Development Site', 'Auction', 10375000, null, null, 290, null, 'B4 - Mixed use Zoning ', '2:1', null, null, 'Freehold building consisting of retail + 1st Floor commercial');
    ...
    insSale.run(uuidv4(), '20 Balfour Road, Rose Bay NSW', 'Rose Bay', 'Eastern Suburbs', 'Residential', 'Auction', 7500000, null, null, 697, null, 'R3 ', '1:1', '2022-09-04', 2022, '4 x 2-Bedroom apartments');
    insSale.run(uuidv4(), '21 Imperial Avenue, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 5700000, null, null, 596, null, 'R3 Medium Density ', '0.6:1', null, null, '- 1900\'s two storey block of units, 4 x 2-bedroom units.');
    insSale.run(uuidv4(), '56 Campbell Parade, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'EOI', 20650000, null, null, 368, null, 'B4 - Mixed use Zoning ', '3:1', '2020-12-01', 2020, '4 x 2-bedroom apartments & commercial shop (trading as a cafe).');
    insSale.run(uuidv4(), '5 South Avenue, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Childcare', 'Auction', 7350000, null, null, 364, null, 'R2 _ Low Densite Residential', null, '2022-05-04', 2022, 'Child Care Centre - Tenant is \'Babies By the Bay\' - license for 29 places');
    insSale.run(uuidv4(), '222-234 Bondi Road & 1 Wellington Street', 'Bondi', 'Eastern Suburbs', 'Development Site', 'Auction', 16000000, null, null, 1388, null, null, '0.9:1', null, null, '7 x Commercial Shops + 7 x Residential 2-bedroom split level apartments + 4 x 2 bedroom plus sunroom apartments (seperate apartment block).');
    ...
    insSale.run(uuidv4(), '100 Marine Parade, Maroubra NSW', 'Maroubra', 'Eastern Suburbs', 'Residential', 'Auction', 8500000, null, null, 550, null, 'R3 Medium Density Residential ', null, null, null, '6 x 2 Bedroom Apartments');
    insSale.run(uuidv4(), '141-143 Curlewis Street, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Development Site', 'Auction', 13500000, 413000, 3.06, 518, 670, null, null, null, null, null);
    insSale.run(uuidv4(), '156 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 15000000, null, null, 449, 200, 'R3 Medium Density ', '0.6', '1991-01-08', 1991, '2 x 3 bedroom');
    insSale.run(uuidv4(), '154 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 22000000, null, null, 465, 480, 'R3 Medium Density ', '0.6', '1991-01-08', 1991, '6 x 2 bedroom');
    ...
    insSale.run(uuidv4(), '234 Bronte Road, Waverley NSW', 'Waverley', 'Eastern Suburbs', 'Commercial Office', 'Auction', 6500000, null, null, 681, 465, 'B4 Mixd Use ', '1:1', null, null, null);
    insSale.run(uuidv4(), '5 Imperial Avenue, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 5235000, null, null, 446, null, 'R3 Medium Density ', '0.6:1 ', null, null, '6 x 2 Bedroom (Strata)');
    insSale.run(uuidv4(), '27 Hall Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Development Site', 'Auction', 23000000, null, null, 593, 558, 'B4 Mixed Use', '2:1', null, null, '6 Residentail apartments + 2 Ground Floor retail shops');
    insSale.run(uuidv4(), '32 Arcadia Street, Coogee NSW', 'Coogee', 'Eastern Suburbs', 'Residential', 'Off-Market', 8200000, null, null, 405, null, 'R3 Medium Density ', '0.75:1', null, null, '6 x 2 Beds');
    insSale.run(uuidv4(), '31 Dudley Street, Coogee NSW', 'Coogee', 'Eastern Suburbs', 'Residential', 'Auction', 5150000, null, null, 455, null, 'R3 Medium Density ', '0.9:1', '2021-01-09', 2021, 'Art deco block with 6 x 2 bedroom apartments');
    insSale.run(uuidv4(), '61 Oceanview Avenue, Dover Heights NSW', 'Dover Heights', 'Eastern Suburbs', 'Residential', 'Auction', 7541000, null, null, 481, null, 'R2 Low Density ', '0.5: 1', null, null, '7 x 2 Bedrooms');
    ...
    insSale.run(uuidv4(), '28 Burton Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 4025000, null, null, 387, null, 'R3 Medium Density ', '0.9:1 ', null, null, '1 x 2 Bedroom Unit + 1 x 3 bedroom Unit');
    insSale.run(uuidv4(), '8 Etham Avenue, Darling Point NSW', 'Darling Point', null, 'Residential', 'EOI', 12000000, null, null, 506, 597, 'R3 medium Density ', '0.9:1 ', null, null, '6 x 2 bedrooms, 1.5 bathroom and 4 garages');
    ...
    insSale.run(uuidv4(), '45 Moira Crescent, Coogee NSW', 'Coogee', 'Eastern Suburbs', 'Residential', 'Auction', 4700000, null, null, 435, null, 'R3 Medium Density ', '0.75:1 ', '2021-07-11', 2021, '2 x 3 Bedroom + 1 x 2 Bedroom (strata Titled)');
    insSale.run(uuidv4(), '10 Carlisle Street, Tamarama NSW', 'Tamarama', 'Eastern Suburbs', 'Residential', 'Off-Market', 15000000, null, null, 612, null, 'R3 Medium Density ', '0.6:1', null, null, '6 x 2 Bedroom + 3 x 1 Bedroom (all with balconies)');
    insSale.run(uuidv4(), '20 Cox Avenue, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 12100000, null, null, 548, 398, 'R2 Low Density Residential ', '0.5:1 ', '2021-04-11', 2021, 'Four apartments: 2 x 3 Bedroom, 1 x 2 Bedroom, 1 x 1 Bedroom');
    insSale.run(uuidv4(), '30 Bennett Street, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Residential', 'Off-Market', 13200000, null, null, 765, null, null, null, null, null, '6 x 2 Bedroom units, 2 x 3 Bedroom Units and 2 x 1 Bedroom units (Not Strata\'d)');
    insSale.run(uuidv4(), '30 Yarranabbe Road, Darling Point NSW', 'Darling Point', null, 'Residential', 'Auction', 9000000, null, null, 340, 337, 'R3 medium Density ', '1:1', null, null, '2 x 3 Bedroom + 1 x 2 Bedroom');
    insSale.run(uuidv4(), '136 Carrington Road, Waverley NSW', 'Waverley', 'Eastern Suburbs', 'Residential', 'Auction', 4910000, null, null, 769, 476, 'R3 medium Density ', '0.6:1 ', null, null, '8 x Studios, 3 x 1 Bedroom, 1 x 3 Bedroom');
    insSale.run(uuidv4(), '3 Moore Street, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 5000000, null, null, 348, null, 'R3 Medium Density ', '0.9:1', '2021-09-12', 2021, '6 x 2 Bedroom');
    insSale.run(uuidv4(), '1 Gordon Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 3300000, null, null, 335, null, null, null, null, null, '6 x 1 bedroom');
    insSale.run(uuidv4(), '225 Avoca Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 8300000, null, null, 598, null, 'R3 medium Density ', '0.75:1', null, null, '6 x 2 Bedroom, 3 x 1 Bedroom');
    insSale.run(uuidv4(), '54 Bishops Avenue, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 3800000, null, null, 335, null, null, null, null, null, '4 x 2 bedroom');
    ...
    insSale.run(uuidv4(), '1 Gordon Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 3300000, null, null, 336, null, 'R2', '0.5:1', null, null, '6 x 1 Bedroom units');
    insSale.run(uuidv4(), '256 New South Head Road, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Residential', 'Auction', 6800000, null, null, 256, null, 'R3 ', null, null, null, '7 Units (1 x 2 Bedroom, 6 x 3 Bedroom)');
    insSale.run(uuidv4(), '50 Roscoe Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 9110000, null, null, null, 445.6, 'R3', '0.9:1', null, null, '7 x 2 Bedroom Units and 1 x 1 Bedroom Unit');
    insSale.run(uuidv4(), '101 Bondi Raod, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Retail', 'Auction', 6070000, null, null, 243, 378, null, null, '2021-04-03', 2021, 'Ground floor retail + 4 x residential apartments');
    insSale.run(uuidv4(), '484-488 New South Head Road, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Residential', 'Auction', 6500000, null, null, 281, 420, 'R3 Medium Density ', '1.7:1', '2021-10-03', 2021, '6 x 2 Bedroom Units');
    insSale.run(uuidv4(), '294 & 296 Birrell Street, Bondi NSW', 'Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 19300000, null, null, 1191, null, 'R3 Medium Density ', '0.9:1', null, null, '19 Units (13 x 2 Bedroom units, 6 x 1 Bedroom units)');
    ...
    insSale.run(uuidv4(), '122 Brighton Boulevard, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 11300000, null, null, null, null, null, null, null, null, null);
    ...
    insSale.run(uuidv4(), '286-294a Campbell Parade, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 25400000, null, null, 689, 1004, null, null, '2020-11-06', 2020, '6 Apartments 4 shops');
    insSale.run(uuidv4(), '49 Mitchell Street, North Bondi NSW', 'North Bondi', 'Eastern Suburbs', 'Residential', 'Auction', 5750000, null, null, 411, 462, null, null, null, null, null);
    ...
    insSale.run(uuidv4(), '9, 11-13 Mulwarree Avenue, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 11435000, null, null, 1305, 1280, null, null, null, null, null);
    insSale.run(uuidv4(), '9 Albert Street, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'EOI', 4000000, null, 2.93, 370, 450, null, null, null, null, '4 x 2 bed + 2 x 1 bed');
    insSale.run(uuidv4(), '22 Greenwich Road', 'Greenwich', null, 'Residential', 'Auction', 9560000, 450000, 4.7, null, 483, null, null, '2019-11-12', 2019, null);
    insSale.run(uuidv4(), '119-121 Alison Road, Randwick NSW', 'Randwick', 'Eastern Suburbs', 'Residential', 'Auction', 5250000, null, null, 714, null, null, null, null, null, '4 x 2 bedroom units');
    insSale.run(uuidv4(), '10-12 Campbell Parade, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', null, 8500000, null, null, 208.7, null, 'B4 Mixed Use ', '3:1', null, null, '6 x 1 Bedroom Units');
    insSale.run(uuidv4(), '54 Bennett Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 10600000, null, null, 595, null, null, null, null, null, '9 units (2 x 3-bed, 5 x 2-bed, 2 x 1-bed)');
    ...
    insSale.run(uuidv4(), '112 O\'Brien Street, Bondi Beach NSW', 'Bondi Beach', 'Eastern Suburbs', 'Residential', 'Auction', 4450000, null, null, 360, null, 'R3 Medium Density ', '0.9:1 ', null, null, null);
    insSale.run(uuidv4(), '27-29 Knox Street, Double Bay NSW', 'Double Bay', 'Eastern Suburbs', 'Development Site', 'Auction', 9830000, null, null, 230, 230, 'B2', '2.5', null, null, 'Tenant: ANZ');
    ...
    insSale.run(uuidv4(), '15 Francis Street, Bondi Beach', 'Bondi Beach', 'Eastern Suburbs', 'Residential', null, 7250000, null, 3.28, 550.1, null, null, null, '2026-04-01', 2026, '4 Units | 4 x 2-Beds with no parking on site');
    insSale.run(uuidv4(), '13 Fletcher Street, Tamarama', 'Tamarama', 'Eastern Suburbs', 'Residential', null, 7800000, null, null, 488.1, null, null, null, '2026-04-01', 2026, '4 Units | 2 x2-Beds & 2 x 3-beds + 4 Lugs');
    insSale.run(uuidv4(), '71 Fletcher Street, Tamarama', 'Tamarama', 'Eastern Suburbs', 'Residential', null, 12000000, null, null, 461, null, null, null, '2026-03-01', 2026, 'Block of 3 | 1 x 4-Bed + 2 x 2-Beds');
    insSale.run(uuidv4(), '11 McKeon Street, Maroubra', 'Maroubra', 'Eastern Suburbs', 'Residential', null, 4210000, null, 3.85, 442, null, null, null, '2026-03-01', 2026, '4 x 3-Bedroom Apartments + Onsite Parking (4 car spaces)');
    insSale.run(uuidv4(), '10 Lancaster Road, Dover Heights', 'Dover Heights', 'Eastern Suburbs', 'Residential', null, 5510000, null, 3.64, 539, null, null, null, '2026-03-01', 2026, '4 Units | 4 x 2-Bedroom Units');
    insSale.run(uuidv4(), '48 Evans Street, Bronte', 'Bronte', 'Eastern Suburbs', 'Residential', null, 7150000, null, 4.15, 537, null, null, null, '2026-03-01', 2026, '6 Units | 6 x 2-Beds + LUGS.');
    insSale.run(uuidv4(), '93 Wentworth Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 7000000, null, 4.3, 585, null, null, null, '2026-02-01', 2026, '9 Units | 6 x 2-Beds + 3 x 1-Beds + LUGS');
    insSale.run(uuidv4(), '78 Alison Road, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 5800000, null, 3.61, 674, null, null, null, '2026-02-01', 2026, '5 Units | 4 x 2-Beds + 1 x 6-Bed + 3 x LUGS');
    insSale.run(uuidv4(), '3 Moore Street, Bondi', 'Bondi', 'Eastern Suburbs', 'Residential', null, 7000000, null, 4.38, 348, null, null, null, '2026-02-01', 2026, '6 x 2-Beds + (1 LUG)');
    insSale.run(uuidv4(), '7 Blenheim Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 10000000, null, 3, 501.6, null, null, null, '2025-12-01', 2025, '6 x 2-Beds + LUGS');
    insSale.run(uuidv4(), '63 Mitchell Street, Bondi Beach', 'Bondi Beach', 'Eastern Suburbs', 'Residential', null, 9021000, null, 3.08, 420.57, null, null, null, '2025-12-01', 2025, '6 x 2-Beds');
    insSale.run(uuidv4(), '4 Prospect Street, Waverley', 'Waverley', 'Eastern Suburbs', 'Residential', null, 5000000, null, null, 348, null, null, null, '2025-12-01', 2025, '4 x 2-Beds');
    insSale.run(uuidv4(), '6A Mitchell Street, North Bondi', 'North Bondi', 'Eastern Suburbs', 'Residential', null, 7095000, null, null, 447, null, null, null, '2025-11-01', 2025, '4 x 2-Beds');
    insSale.run(uuidv4(), '2 Ormond Street, Bondi Beach', 'Bondi Beach', 'Eastern Suburbs', 'Residential', null, 10000000, null, null, 607, null, null, null, '2025-11-01', 2025, '1 x 3-Bed, 6 x 2-Beds, 3 x 1-Beds  + 10 Car Spaces');
    insSale.run(uuidv4(), '179 Hastings Parade, North Bondi', 'North Bondi', 'Eastern Suburbs', 'Residential', null, 15160000, null, null, 487, null, null, null, '2025-11-01', 2025, '4 x 2-Beds, 1 x 3-Beds + 4 Car Spaces');
    insSale.run(uuidv4(), '57 Regent Street, Paddington', 'Paddington', 'Eastern Suburbs', 'Residential', null, 11000000, null, 4.02, 429, null, null, null, '2025-10-01', 2025, '10 x 1-Beds + 2 x 2-Beds');
    insSale.run(uuidv4(), '12 Court Road, Double Bay', 'Double Bay', 'Eastern Suburbs', 'Residential', null, 12425000, null, 3.65, 448, null, null, null, '2025-10-01', 2025, '9 x 2-Beds + 1 Car Space');
    insSale.run(uuidv4(), '5 Henrietta Street, Double Bay', 'Double Bay', 'Eastern Suburbs', 'Residential', null, 19175000, null, null, 767, null, null, null, '2025-10-01', 2025, '7 x 2-Beds + 7 x 1-Beds + 16  Car Spaces');
    insSale.run(uuidv4(), '81-83 Henrietta Street, Waverley', 'Waverley', 'Eastern Suburbs', 'Residential', null, 4615000, null, 3.4, 332, null, null, null, '2025-10-01', 2025, '4 x 2-Beds');
    insSale.run(uuidv4(), '102 Warners Avenue, Bondi Beach', 'Bondi Beach', 'Eastern Suburbs', 'Residential', null, 7400000, null, 2.76, 394, null, null, null, '2025-10-01', 2025, '2 x 2-Beds + 2 x 3-Beds');
    insSale.run(uuidv4(), '21 Creer Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 6200000, null, null, 440, null, null, null, '2025-10-01', 2025, '5 x 2-Beds + 5 Car Spaces');
    insSale.run(uuidv4(), '117 Maroubra Road, Maroubra', 'Maroubra', 'Eastern Suburbs', 'Residential', null, 3900000, null, 3.97, 354, null, null, null, '2025-10-01', 2025, '4 x 2-Beds');
    insSale.run(uuidv4(), '14 St Pauls Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 5000000, null, null, 436.3, null, null, null, '2025-10-01', 2025, '4 x 2-Beds + 2 x LUGS');
    insSale.run(uuidv4(), '74 Cowper Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 4900000, null, null, 546, null, null, null, '2025-09-01', 2025, '4 x 2-Beds');
    insSale.run(uuidv4(), '5 Alexander Street, Coogee', 'Coogee', 'Eastern Suburbs', 'Residential', null, 7500000, null, null, 417, null, null, null, '2025-09-01', 2025, '3 x 2-Beds + 3 x 1-Beds + LUGS');
    insSale.run(uuidv4(), '12 Pitt Street, Randwick', 'Randwick', 'Eastern Suburbs', 'Residential', null, 6900000, null, 3.84, 361, null, null, null, '2025-09-01', 2025, '6 x 2-Beds + 3 LUGS');
    insSale.run(uuidv4(), '55-61 Riley Street, Woolloomooloo NSW', 'Woolloomooloo', 'Eastern Suburbs', 'Commercial', 'Off-Market', 13500000, null, null, null, 608, 'MU1 - Mixed Use', '2:1', '2024-01-01', 2024, 'Commercial freehold; three frontages & Art Deco Facade. Building features exposed internal brickwork, a pitched 6m ceiling with original steel beams, steel framed windows and timber floorboards.');
    insSale.run(uuidv4(), '63 Ann Street, Surry Hills NSW', 'Surry Hills', 'Eastern Suburbs', 'Commercial', 'EOI', 32250000, null, null, null, 2361, 'MU1 - Mixed Use', '3.5:1', '2023-12-01', 2023, 'Originally built as a warehouse in the 1920\'s: asset underwent refurbishment in 2020. Property has three street frontages with basement parking. Currently 78% occupied with a WALE of 3.88 years and average passing rent of 989sqm gross. Advertised as offering strong rental reversion. 5.0 star NABERS rating with new end of trip facilities. The property was originally known as the Lamson Paragon Factory, the outside is a double brick.');
    ...
    insSale.run(uuidv4(), '52 William Street, Woolloomooloo NSW', 'Woolloomooloo', 'Eastern Suburbs', 'Commercial', 'Off-Market', 102300000, null, null, null, 5508, 'MU1 - Mixed Use', '5:1', '2022-10-01', 2022, 'Commercial office building was purchased by Sydney Catholic Schools. The building is heritage listed with the school having submitted plans to transform it into an additional St Mary\'s campus - converting the use from commercial to educational.');
    insSale.run(uuidv4(), '256 Crown Street, Surry Hills NSW', 'Surry Hills', 'Eastern Suburbs', 'Commercial', 'EOI', 20357000, null, null, 512, 1168, 'MU1 - Mixed Use', '5:1', '2022-09-01', 2022, 'Rare island site: Three level commercial freehold (circa 390 floor plates) with 6 (six) car parking bays. Sold with further development potential by the City of Sydney led Oxford Street Planning.');
    insSale.run(uuidv4(), '83-85 McLachlan Avenue, Darlinghurst NSW', 'Darlinghurst', 'Eastern Suburbs', 'Commercial', 'Auction', 10000000, null, null, 411, 682, 'B4 - Mixed Use Zoning', '2.5:1', '2022-05-01', 2022, 'Modern Commercial Building - Advertised as a turnkey opportunity with 12 (twelve) on site car spaces. Property has a existing office fitout.');
    ...
    insSale.run(uuidv4(), '1-19 Hargrave Street, Darlinghurst NSW', 'Darlinghurst', 'Eastern Suburbs', 'Commercial Office', 'EOI', 35500000, null, null, 1489, 3124.3, 'MU1 - Mixed Use', '5 :1 (restricted to 4,420m2 per section 88B). ', '2024-07-01', 2024, 'The former Sony Music Building bought by Sydney Grammer School. The property had a NLA of 3,124.3 of adaptable office space and a Total GFA of 3,903. The warehouse conversion was seen as an opportunity to add-value, occupy or develop (STCA). The property was situated over three levels with a rootfop car park. The property had 36 metres of frontage across three street frontages. The floor plates were circa 1,250sqm - 1,300sqm per floor plate. The property also had 72 car spaces on the ground floor and rooftop which could be accessed via College Street.');
